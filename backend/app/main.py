...
Routes:
  ...
  /api/commands/*             — command submission & result poll (JWT required)
  /api/device/*               — device-facing command fetch/result (X-Device-Api-Key)
"""
...
from routers import admin, auth, commands, device_agent, devices

logging.basicConfig(level=logging.INFO)

app = FastAPI(title="Device Management API", version="0.2.0")
